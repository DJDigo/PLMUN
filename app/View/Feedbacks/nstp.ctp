    ...
    <div class="admin" id="admin-page" data-aos="fade-up" data-aos-duration="2000">
        <div class="admin-container">
            <div class="admin-course-description">
                <span class="admin-course-title"> <?php echo $nstp['Nstp']['title'] ?> </span>
                <span class="admin-course-department"><?php echo strtoupper($department[$nstp['Nstp']['department_id']]) ?></span>
                <p><?php echo $nstp['Nstp']['description'] ?></p>
...
<div class="admin-course-feedback">
    ...
    <form class="admin-feedback-form" autocomplete="off" method="POST">
        ...
        <input type="hidden" name="type" value="<?php echo $type['nstp'] ?>">
